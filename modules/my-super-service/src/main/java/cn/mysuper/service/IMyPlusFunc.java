...
public interface IMyPlusFunc {
     ...
     * 2、方法名不能重载
     * */
    public List myFun(final String methodName, final Object... ps);
    ...
    public List myInvoke(final String methodName, final String user_token, final Object... ps);
    ...
    public List myInvokeLink(final String methodName, final String user_token, final Object... ps);
    ...
    public List myInvokeAllFuncScenes(final String methodName, final String user_token, final Object... ps);
    //public Object myInvokeAllFuncScenes(final String methodName, final Long group_id, final Object... ps);
